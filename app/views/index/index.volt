...
<div class="row">
	<div id="carousel-inicio" class="carousel slide" data-ride="carousel">
	  ...
	  <div class="carousel-inner" role="listbox">
  	    ...
  	    {{ image("img/index/BANNER_ENTREGA_INFO_junio.jpg", "alt": "Interventoría Buen Comienzo") }}
  	  </div>
				<div class="item">
  	    {{ image("img/index/propuesta5_banner_ppal.jpg", "alt": "Interventoría Buen Comienzo") }}
  	  </div>
	  </div>
	  <!-- Controles -->
